  ...
  return (
    <section className="service-page">
      <div className="heading">
        ...
        <q className="quote">{service?.description}</q>
      </div>
      ...
      <div className="content service_page-content">
        <div className="left-side">
          <h4 className="child dsc1">{service?.goals_objectives_text}</h4>
        </div>
        <div className="right-side">
          <div className="sub_text">
            ...
            <p className="paragraph py-4">{service?.content_sec1}</p>
            <h2 className="artcile__info headline4">{service?.title_sec2}</h2>
            <p className="paragraph py-4">{service?.content_sec2}</p>
          </div>

          <div className="content_heading pt-5 pb-4 sub_text">
            <h1 className="headline3">{service?.title_process}</h1>
          </div>
              ...
              .map((item, i) => (
                <div key={item.id} className="step">
                  ...
                  <div className="step-number">
                    <h3 className="headline3">{item.index_number}</h3>
                  </div>
                </div>
              ))}
          </div>
      ...
      <div className="content service_page-content">
        <div className="left-side">
          <h4 className="headline4">{service?.title_present_project}</h4>
        </div>
        <div className="right-side">
          <p className="paragraph sub_text">{service?.mini_text}</p>
          <div className="admin">
